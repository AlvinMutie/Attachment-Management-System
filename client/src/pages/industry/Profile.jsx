            ...
            <div className="space-y-8 animate-fade-in">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 bg-gradient-to-r from-blue-600/10 to-transparent p-10 rounded-[2.5rem] border border-white/5 shadow-2xl">
                    ...
                    <div className="text-center md:text-left space-y-2">
                        ...
                        <p className="text-slate-500 font-medium">{data.department} • {data.company}</p>
                        <div className="flex flex-wrap gap-4 pt-2">
                            <div className="flex items-center space-x-2 text-xs font-bold text-slate-400 uppercase tracking-widest">
                                <Users size={14} className="text-blue-500" />
                                <span>{data.activeStudents} Managed Students</span>
                            </div>
                            <div className="flex items-center space-x-2 text-xs font-bold text-slate-400 uppercase tracking-widest">
                                <Shield size={14} className="text-purple-500" />
                                <span>Verified Mentor Account</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        <div className="glass-card p-8 space-y-6">
                            <h3 className="text-lg font-black text-white flex items-center space-x-2">
                                ...
                                <span className="uppercase tracking-widest text-xs">Employment</span>
                            </h3>
                            <div className="space-y-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm font-bold text-slate-300">{data.company}</p>
                                </div>
                                <div className="space-y-1">
                                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Expertise</p>
                                    <p className="text-sm font-bold text-slate-300">Cloud & Data Infrastructure</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="glass-card p-10 space-y-10">
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    <label className="text-xs font-black uppercase tracking-[0.2em] text-slate-500">Corporate Email</label>
                            ...
                            <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-6">
                                <div className="space-y-1">
                                    <p className="text-sm font-bold text-white">Verification Alerts</p>
                                    <p className="text-xs text-slate-500">Get notified when students clock-in for the day.</p>
                                </div>
