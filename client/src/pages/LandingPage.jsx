    ...
    return (
        <div className="min-h-screen bg-[#0d0e12] font-sans text-slate-100 selection:bg-violet-500/30 overflow-x-hidden transition-colors duration-200">
            ...
            <section className="relative pt-32 sm:pt-40 pb-16 overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-10">
                    ...
                    >
                        ...
                        {/* Subtitle */}
                        <p className="mt-6 text-sm sm:text-base md:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed font-normal">
                        ...
                        {/* Dual Action CTAs - Crisp, High Contrast & High Visibility in Both Dark & Light */}
                        <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-3.5">
                            <Link to="/login" className="w-full sm:w-auto">
                                <button
                                    type="button"
                                    className="w-full sm:w-auto px-8 py-3.5 bg-violet-600 hover:bg-violet-500 text-white font-bold rounded-xl shadow-lg shadow-violet-600/30 flex items-center justify-center gap-2 text-sm border border-violet-400/40 transition-all cursor-pointer select-none active:scale-[0.98]"
                                >
                                    <LogIn size={16} />
                                    <span>Sign In</span>
                                    <ArrowRight size={16} />
                            ...
                            <Link to="/signup" className="w-full sm:w-auto">
                                <button
                                    type="button"
                                    className="w-full sm:w-auto px-8 py-3.5 bg-[#151722] hover:bg-[#1f2230] text-slate-100 hover:text-white font-bold rounded-xl border-2 border-[#2e3244] shadow-md flex items-center justify-center gap-2 text-sm transition-all cursor-pointer select-none active:scale-[0.98] outline-cta-btn"
                                >
                ...
                >
                    {stats.map((stat, idx) => (
                        <motion.div
                            key={idx}
                            variants={fadeInUp}
                            className="bg-[#12141c] border border-[#22242f] rounded-2xl p-5 hover:border-[#2f3244] transition-all duration-200 group shadow-sm"
                        >
                ...
                >
                    {faqs.map((faq, idx) => (
                        <motion.div
                            key={idx}
                            variants={fadeInUp}
                            className="rounded-xl bg-[#12141c] border border-[#22242f] overflow-hidden transition-all shadow-sm"
                        >
                            <button
            ...
            <section className="relative max-w-6xl mx-auto px-4 sm:px-6 py-16">
                <motion.div
                    className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-violet-950/70 via-indigo-950/60 to-slate-950/80 border border-violet-500/40 p-8 sm:p-12 text-center shadow-2xl"
                ...
                >
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3.5">
                        <Link to="/signup" className="w-full sm:w-auto">
                            <button
                                type="button"
                                className="w-full sm:w-auto px-8 py-3.5 bg-violet-600 hover:bg-violet-500 text-white font-bold rounded-xl shadow-lg shadow-violet-600/30 text-sm border border-violet-400/40 flex items-center justify-center gap-2 transition-all cursor-pointer select-none active:scale-[0.98]"
                            >
                                <span>Register</span>
                                <ArrowRight size={16} />
                            </button>
                        ...
                        <Link to="/login" className="w-full sm:w-auto">
                            <button
                                type="button"
                                className="w-full sm:w-auto px-8 py-3.5 bg-[#151722] hover:bg-[#1f2230] text-slate-100 hover:text-white font-bold rounded-xl border-2 border-[#3d4257] shadow-md flex items-center justify-center gap-2 text-sm transition-all cursor-pointer select-none active:scale-[0.98] outline-cta-btn"
                            >
